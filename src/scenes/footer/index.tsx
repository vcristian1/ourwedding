    ...
    <footer className="bg-slate-100 py-5 shadow-xl overflow-x-hidden">
        <div className="justify-content mx-auto w-5/6 gap-16 md:flex">
            <div className="mt-16 basis-1/2 md:mt-0">
                ...
                <p className="mt-4 text-sm sm:text-[16px] ipp:text-[20px] sp7:text-[22px] lg:text-[14px] del:text-[16px] mbpro:text-[16px] md:text-[14px]">© Designed and Developed by Cristian C. Vargas</p>
            </div>
            ...
            <div className="gfold:text-[14px] mt-16 basis-1/4 md:mt-4 ipp:text-[20px] sp7:text-[22px] lg:text-[14px] del:text-[16px] mbpro:text-[16px] md:text-[14px]">
                <h4 className="lg:text-[16px] font-bold mbpro:text-[18px] md:text-[16px]">Travel Agent Contact</h4>
