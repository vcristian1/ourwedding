  ...
  return (
    ...
    >
        ...
        >
            ...
            >                    
                <h1 className='gfold:text-center md:text-left text-2xl md:text-4xl sm:text-4xl font-bold ipp:text-5xl sp7:text-[40px] xlg:text-5xl'>Our Story</h1>
                <div className='md:flex md:gap-6 mbpro:gap-6'>
                    <div className=''>
                        ...
                        <p className="my-5 md:text-[17px] sm:text-[20px] ipp:text-[22px] sp7:text-[24px] xlg:text-[20px]">"Your support over the years has truly been appreciated, and we thank you all for choosing to share this special day with us. See you in September!" - Jacqueline & Cristian</p>
                    </div>
