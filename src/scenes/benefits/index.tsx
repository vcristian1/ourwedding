  ...
  return (
    ...
    >
        ...
        >
            ...
            >                    
                <p className='text-2xl md:text-4xl sm:text-4xl font-bold sm:text-center md:text-left'>Our Story</p>
                <div className='md:flex md:gap-6'>
                    <div className=''>
                        <p className="my-5 md:text-[17px] sm:text-[20px]">
                        ...
                        <p className="my-5 md:text-[17px] sm:text-[20px]">Our story unfolds through shared experiences—the laughter of our first date at Red Robin, the scenic roads of Colorado on our inaugural road trip, and the warmth of my 21st birthday at Four Roses Pub with her family. Further chapters include our first vacation in Arizona with my family and a Thanksgiving cruise in 2021—a celebration of our commitment to explore the world together.</p>
                        <p className="my-5 md:text-[17px] sm:text-[20px]">As we stand on the verge of matrimony, these moments, woven into the fabric of our love, resonate deeply. We invite you to join us on this special day, as we exchange vows and step into the next chapter of our journey. Let's revel in the joy of love and shared adventures!</p>
                    </div>
                    <div className='sm:mx-[65px]'>
