            ...
            <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
                <div>
                    ...
                    <div className="mb-10">                        
                        ...
                        <p className="sm:text-[18px] sp7:text-[22px] lg:text-[18px] mbpro:text-[18px]">There is a cancellation policy, please reach out to Donna Shapiro our travel agent to confirm the policy details. Her contact information can be found at the bottom of the website.</p>
                    </div>
                ...
                <div>
                    ...
                    <div className="mb-10">
                        ...
                        <p className="sm:text-[18px] sp7:text-[22px] lg:text-[18px] mbpro:text-[18px]">All guests are responsible for booking their own flights. For airport transfer arrangements, contact our travel agent Donna Shapiro to provide her with your flight information.</p>
                    </div>
                </div>
            </div>
