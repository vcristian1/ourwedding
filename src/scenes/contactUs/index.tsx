  ...
  return (
    <section id="faqs" className='bg-[#C89F79] mx-auto w-full pt-24 pb-32'>
        <motion.div
         ...
         className='gs8:mx-[30px] xs:mx-[30px] sm:mx-[65px] ipp:mx-[90px] lg:mx-[120px]'
        >
            {/* HEADER HERE */}
            <motion.div
             className="w-full"
            ...
            <div className='md:flex'>
                <div>
                    <p className='text-2xl md:text-4xl font-bold sm:text-3xl ipp:text-5xl'>FAQS</p>
                    <p className="sm:text-[18px]my-5 sm:text-[18px] sm:mt-6 sm:mb-6 ipp:text-[22px]">
            ...
            <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
                <div>
                    <div className="mb-10">
                        <h3 className="flex items-center mb-4 text-lg font-medium sm:text-[20px] ipp:text-[22px]">
